...
1. #### You open Claude Code
   ...
   The **SessionStart** hook prints three lines: a heading, what reusing your project's memory saved, and where this project stands — concepts you are learning, concepts you have mastered, concepts due for review, and the level you are working through. Your dials are in the status bar and anything longer lives in `eklavya dashboard`. Claude receives more than you see: the same hook hands it the relevant history of this project, framed as evidence to check rather than instructions to follow. `quiet: true` turns the three lines off and leaves the rest working.
