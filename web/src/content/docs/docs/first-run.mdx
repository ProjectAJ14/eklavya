...
4. #### It asks you to choose a focus
   ...
   Both answers are written to `~/.eklavya/config.json` — or to `~/.eklavya/projects/<checkout>/config.json` if you say you want them to apply to this project only. Either way the file is in your home directory: Eklavya writes nothing into the repository. You can change them any time with [`/eklavya:mode`](/docs/commands/#eklavyamode-value).
