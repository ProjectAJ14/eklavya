...
4. #### A question lands at the seam
   ...
   Four options arrive through Claude Code's own question UI, under an **Eklavya** header so you can see who is asking. Picking one is a keystroke. The bracketed line above the question names the settings that produced it — mode, focus, level, what the tier is asking for, and `· q 2/3` when more are coming. It sits above rather than below because the question UI draws everything in one weight, and underneath it read as part of the question.
