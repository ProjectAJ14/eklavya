...
| Path | What it holds |
| --- | --- |
| `~/.eklavya/knowledge.db` | SQLite, WAL mode: concepts and their prerequisite edges, your mastery per concept, every attempt, what each session logged, the gates, and each project's level. |
