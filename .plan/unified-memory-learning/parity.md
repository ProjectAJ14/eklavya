...
| PAR-03 | done | `memory/replay.ts` reads the transcript directory, applies the privacy filter, is idempotent, and converges with hook capture by content. `memory-replay.test.ts`, eleven cases. |
