...
2. #### Install the plugin
   ...
   The part before the `@` is the plugin, the part after is the marketplace it comes from — they happen to share a name. Claude Code downloads the plugin and registers its MCP server, its five hooks and its seven slash commands.
